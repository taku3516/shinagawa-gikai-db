      ...
      "members": [
        {
          ...
          "career": "平成17年に東京都第3区で初当選。内閣総理大臣補佐官などを歴任。令和6年・令和8年の総選挙で当選し現職。 衆院選アーカイブは平成26年（第47回）以降のみ収録しているため、当選回数は表示していません。",
          "electionHistory": [
            "2026 衆議院議員総選挙：当選（93,158.548票・42.6%）",
            "2024 衆議院議員総選挙：当選（61,660.983票・30.5%）",
            "2021 衆議院議員総選挙：比例復活（116,753票・42.9%）",
            "2017 衆議院議員総選挙：当選（107,708票・43.6%）",
            "2014 衆議院議員総選挙：当選（115,623票・44.3%）"
          ],
          "fundReports": [
            {
      ...
      "members": [
        {
          ...
          "career": "品川区議会議員（平成18年〜令和2年）・東京都議会議員（令和3年〜令和7年）を経て、令和6年の総選挙で衆議院議員に当選（東京都第3区で立候補し比例東京ブロックで復活当選）。令和8年の総選挙で落選。 衆院選アーカイブは平成26年（第47回）以降のみ収録しているため、当選回数は表示していません。",
          "electionHistory": [
            "2026 衆議院議員総選挙：落選（53,584票・24.5%）",
            "2024 衆議院議員総選挙：比例復活（54,178票・26.8%）",
            "2021 東京都議会議員選挙：当選（20,087票・14.2%）",
        ...
        },
        {
          ...
          "career": "東京都議会議員（大田区選挙区・平成元年〜平成8年、2期）を経て衆議院議員。東京都第3区（品川区）で複数期当選。国家公安委員長・拉致問題担当大臣などを歴任。 衆院選アーカイブは平成26年（第47回）以降のみ収録しているため、当選回数は表示していません。",
          "electionHistory": [
            "2021 衆議院議員総選挙：当選（124,961票・45.9%）",
            "2017 衆議院議員総選挙：比例復活（94,380票・38.2%）",
            "2014 衆議院議員総選挙：比例復活（111,353票・42.6%）"
          ],
          "aliases": [
            "まつばら仁"
          ]
        },
        {
          ...
          "career": "経済人類学者・大学教授を経て、平成8年の総選挙で東京都第3区から衆議院議員に当選（1期）。 衆院選アーカイブは平成26年（第47回）以降のみ収録しているため、当選回数は表示していません。"
        }
      ]
    },
    "current-mayor": {
